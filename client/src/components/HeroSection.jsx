    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-black text-white px-6">
            <div className="max-w-2xl w-full">
                ...
                <div className="absolute inset-0 opacity-30 blur-3xl bg-gradient-to-r from-white via-gray-400 to-white" />
                ...
                <div className="relative text-center space-y-6">
                    ...
                    <button
                        ...
                        className="mt-6 px-7 py-3  cursor-pointer rounded-full bg-white text-black font-bold tracking-wider uppercase hover:scale-102 active:scale-95 transition"
                    >
                        Start Game
                    </button>
                </div>
